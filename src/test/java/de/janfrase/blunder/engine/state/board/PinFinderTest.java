...
class PinFinderTest {
    ...
    void isPinnedDiagonalSimple() {
        ...
        assertFalse(PinFinder.isPinned(2, 3));
        assertTrue(PinFinder.isPinned(3, 4));
        assertFalse(PinFinder.isPinned(4, 5));
    }
    ...
    void isPinnedStraightSimple() {
        ...
        assertFalse(PinFinder.isPinned(3, 3));
        assertTrue(PinFinder.isPinned(3, 4));
        assertFalse(PinFinder.isPinned(3, 5));
    }
    ...
    void isPinnedDiagonalDouble() {
        ...
        assertTrue(PinFinder.isPinned(2, 3));
        assertTrue(PinFinder.isPinned(3, 4));
        assertFalse(PinFinder.isPinned(4, 5));
    }
}
