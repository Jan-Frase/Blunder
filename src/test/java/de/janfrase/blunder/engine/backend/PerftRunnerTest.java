...
public class PerftRunnerTest {
    ...
    @Test
    void Position7Test() {
        FenParser.loadFenString("7k/1pp3p1/p5Kr/P3r1p1/1P3b2/B1P2B1P/2Q3P1/3R4 w - - 7 40");
    ...
    @Test
    void Position9Test() {
        FenParser.loadFenString("7k/1pp3p1/p2r2K1/P5p1/1P3b2/B1P1rB1P/2Q3P1/8 w - - 2 38");
