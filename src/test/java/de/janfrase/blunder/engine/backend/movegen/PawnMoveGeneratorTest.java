...
public class PawnMoveGeneratorTest {
    ...
    /*
        * 13:05:29.478 [Test worker] TRACE de.janfrase.blunder.engine.backend.MoveGenerator - Starting move generation
    13:05:29.478 [Test worker] TRACE de.janfrase.blunder.engine.backend.MoveGenerator - Finished move generation
    13:05:29.479 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.game.GameState - Unmaking move h5h8.
    13:05:29.479 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.board.BoardRepresentation - Placing ROOK from BLACK on x=7 y=3
    13:05:29.479 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing EMPTY from EMPTY on x=7 y=0
    13:05:29.480 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Finished unmaking move:
    ◻◼◻◼◻◼◻◼
    ◼◻♟◻◼◻◼◻
    ◻◼◻♟◻◼◻◼
    ♔♙◼◻◼◻◼♜
    ...
    13:05:29.480 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Making move f4f3.
    13:05:29.480 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.board.BoardRepresentation - Placing PAWN from BLACK on x=5 y=5
    13:05:29.481 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing EMPTY from EMPTY on x=5 y=4
    13:05:29.481 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.game.GameState - Finished making move:
    ◻◼◻◼◻◼◻◼
    ◼◻♟◻◼◻◼◻
    ◻◼◻♟◻◼◻◼
    ♔♙◼◻◼◻◼♜
    ...
    13:05:29.481 [Test worker] TRACE de.janfrase.blunder.engine.backend.movegen.MoveGenerator - Starting move generation
    13:05:29.482 [Test worker] TRACE de.janfrase.blunder.engine.backend.MoveGenerator - Finished move generation
    13:05:29.482 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Unmaking move f4f3.
    13:05:29.482 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing PAWN from BLACK on x=5 y=4
    13:05:29.482 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.board.BoardRepresentation - Placing EMPTY from EMPTY on x=5 y=5
    13:05:29.483 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Finished unmaking move:
    ◻◼◻◼◻◼◻◼
    ◼◻♟◻◼◻◼◻
    ◻◼◻♟◻◼◻◼
    ♔♙◼◻◼◻◼♜
    ...
    13:05:29.483 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Making move f4e3.
    13:05:29.483 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing PAWN from BLACK on x=4 y=5
    13:05:29.484 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing EMPTY from EMPTY on x=5 y=4
    13:05:29.484 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing EMPTY from EMPTY on x=4 y=6
    13:05:29.484 [Test worker] TRACE de.janfrase.blunder.engine.backend.game.GameState - Finished making move:
    ◻◼◻◼◻◼◻◼
    ◼◻♟◻◼◻◼◻
    ◻◼◻♟◻◼◻◼
    ♔♙◼◻◼◻◼♜
    ...
    13:05:29.485 [Test worker] TRACE de.janfrase.blunder.engine.backend.MoveGenerator - Starting move generation
    13:05:29.485 [Test worker] TRACE de.janfrase.blunder.engine.backend.MoveGenerator - Finished move generation
    13:05:29.485 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.game.GameState - Unmaking move f4e3.
    13:05:29.485 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.board.BoardRepresentation - Placing PAWN from BLACK on x=5 y=4
    13:05:29.486 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing PAWN from WHITE on x=4 y=5
    13:05:29.486 [Test worker] TRACE de.janfrase.blunder.engine.backend.board.BoardRepresentation - Placing PAWN from WHITE on x=4 y=6
    13:05:29.486 [Test worker] TRACE de.janfrase.blunder.engine.backend.state.game.GameState - Finished unmaking move:
    ◻◼◻◼◻◼◻◼
    ◼◻♟◻◼◻◼◻
    ◻◼◻♟◻◼◻◼
    ♔♙◼◻◼◻◼♜
